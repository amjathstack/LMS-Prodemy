...
export default function EnrolledStudentsPage() {
  ...
  return (
    <div className="lg:ml-64 px-4 py-6 md:p-10">
      <h2 className="text-xl md:text-2xl font-semibold mb-6">Enrolled Students</h2>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {Array.isArray(enrolledStudents) && enrolledStudents?.length > 0 && enrolledStudents?.map((s, index) => (
          <div
            key={index}
