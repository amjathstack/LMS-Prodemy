  ...
  return (
    ...
    <div className="min-h-screen">
      ...
      <header className="border-b bg-white">
        <div className="py-4">
          <h1 className="text-lg font-semibold">My Enrolled Courses</h1>
          <p className="text-sm text-gray-600">Continue learning where you left off</p>
        </div>
      </header>
      ...
      <main className="py-6">
        <div className="w-full flex items-center justify-center">
          <div className="grid gap-3 sm:gap-7 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
            ...
            {!isLoading && Array.isArray(enrolledCourses) && enrolledCourses.length === 0 &&
              <h1>You have no enrolled courses yet</h1>
            }
