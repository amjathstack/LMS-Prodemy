"use client";
import { hideCourseAddForm } from "@/app/lib/features/componentStatusSlice";
import { addCourse } from "@/app/lib/features/coursesSlice";
...
export default function AddCoursePage() {
    ...
    return (
        <div className="fixed flex flex-col items-center justify-center w-full h-[100vh] left-0 top-0 bg-black/40 text-sm z-50">
            <div className="max-h-[90%] w-full max-w-200 bg-white py-6 px-2 md:p-8 overflow-hidden rounded-sm shadow-lg">
                <div className="flex w-full items-center justify-between px-2 mb-8">
                    <h2 className="text-xl md:text-2xl font-semibold">Create New Course</h2>
                    <button
                        className="cursor-pointer"
                        onClick={() => dispatch(hideCourseAddForm())}
                    >
                        <X />
                    </button>
                </div>
                ...
                <div className="max-h-[90%] px-3 bg-white overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400">
                    <form onSubmit={handleSubmit} className="space-y-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full border border-gray-300 px-3 py-2 rounded-sm h-28 outline-none"
                        ...
                        <div>
                            ...
                            <label className="flex items-center max-w-70 justify-center gap-4 border border-gray-300 rounded-sm p-4 h-40 cursor-pointer hover:bg-gray-50 outline-none">
                                {prevThum ? (
                                    <Image
                                        src={prevThum}
                                        width={600}
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full border border-gray-300 px-3 py-2 rounded-sm h-24 outline-none"
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {formData.learningPoints.map((point, idx) => (
                                    <div
                                        key={idx}
                                        className="flex items-center gap-3 border border-gray-200 rounded-sm px-3 py-2 bg-gray-50 outline-none"
                                    >
                                        <input
                                            type="text"
                                            value={point}
                        ...
                        <div>
                            ...
                            {formData.lessons.map((lesson, lessonIdx) => (
                                <div
                                    key={lessonIdx}
                                    className="border-b md:border border-gray-200 rounded-sm py-2 md:p-5 md:bg-gray-50 mb-6"
                                >
                                    <input
                                        type="text"
                                        value={lesson.title}
                                    ...
                                    {lesson.lectures.map((lecture, lectureIdx) => (
                                        <div
                                            key={lectureIdx}
                                            className="border border-gray-300 rounded-sm p-4 mb-3 bg-white"
                                        >
                                            ...
                                            <div className="flex items-center gap-3 border-b border-gray-200 pb-2 mb-3">
                                                <input
                                                    ...
                                                    className="rounded-sm w-full focus:outline-none"
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    className="w-full border border-gray-200 px-3 py-2 rounded-md outline-none"
                                                    placeholder="e.g. 12"
                                                />
                                    ...
                                    <div className="max-w-[80%] ml-[10%] md:ml-0 md:max-w-full flex items-center justify-between">
                                        <button
                                            type="button"
