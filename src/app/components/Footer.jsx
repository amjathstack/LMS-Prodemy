export default function Footer() {
  ...
  return (
    ...
    <footer className="px-3 w-full text-sm text-slate-500 bg-white pt-5 mt-20 sm:mt-50">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
        ...
        <div className="flex flex-col lg:items-center lg:justify-center">
          <div className="flex flex-col text-sm space-y-2.5">
            ...
            <a className="hover:text-slate-600 transition" href="#">
              Careers
              <span className="text-xs text-white bg-[#27AE60] rounded-md ml-2 px-2 py-1">
                We’re hiring!
              </span>
            </a>
        ...
        <div>
          ...
          <div className="text-sm space-y-6 max-w-sm">
            ...
            <div className="flex items-center justify-center gap-2 p-2 rounded-sm border border-gray-200">
              <input
                className="focus:ring-2 bg-white ring-[#27AE60] outline-none w-full max-w-64 py-2 rounded px-2"
                type="email"
                placeholder="Enter your email"
              />
              <button className="bg-[#27AE60] px-4 py-2 text-white rounded">
                Subscribe
              </button>
            </div>
          </div>
